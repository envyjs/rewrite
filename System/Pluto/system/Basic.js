...
export default {
  ...
  exec: async function (Root) {
    ...
    await vfs.writeFile(
      "Root/Library/Subsystems/Pluto/panics/pluto_" + makeId(16) + ".panic",
      err + "\n\n" + err.stack + "\n\n\n" + new Date().toString()
    );
    ...
    function makeRecoveryCardButton(
      ...
      const btn = new Html("button")
        .style({
          ...
          "border-radius": "12px",
          border: `1px solid var(--${dangerous ? "negative-light" : "outline"
            })`,
          "align-items": "center",
          padding: "20px",
          gap: "16px",
        ...
        case "normal":
          recoveryOptionsListing.clear().appendMany(
            ...
            makeRecoveryCardButton(
              ...
              () => window.open("https://github.com/envyjs/os/issues/new"),
    ...
    const recoveryWindow = new Html("div")
      ...
      .append(
        new Html("div")
          ...
          .appendMany(
            new Html("h1").class("m-0").text("Recovery - Pluto Subsystem for Envy"),
            new Html("p")
              .class("m-0")
              .text(
                "The Pluto subsystem encountered an error that it couldn't recover from."
              ),
            new Html("a")
              .class("m-0")
              .styleJs({
